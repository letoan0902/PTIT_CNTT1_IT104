...
class Store {
    ...
    listCustomerOrders(customerId) {
        ...
        if (!list.length)
            return alert("Khách hàng chưa có đơn nào");
        list.forEach(o => alert(o.getDetail() + "\n"));
    }
    caculateTotalRevenue() {
        return this.orders.reduce((sum, o) => sum + o.totalAmount, 0);
    }
    countProductByCategory() {
        const counter = this.products.reduce((acc, p) => {
            var _a;
            const cat = p.getCategory();
            acc[cat] = ((_a = acc[cat]) !== null && _a !== void 0 ? _a : 0) + 1;
            return acc;
        }, {});
...
let a = 1;
while (a > 0) {
    let choice = prompt(`=== MENU E-COMMERCE ===
        1) Thêm khách hàng
    ...
    switch (choice) {
        ...
        case "2": {
            const type = (_b = prompt("Loại sản phẩm (E/C): ")) === null || _b === void 0 ? void 0 : _b.toUpperCase();
            const name = String((_c = prompt('Tên sản phẩm: ')) === null || _c === void 0 ? void 0 : _c.trim());
            ...
            if (type === "E") {
                ...
                const size = String((_d = prompt("Size: ")) === null || _d === void 0 ? void 0 : _d.trim());
                const color = String((_e = prompt("Màu: ")) === null || _e === void 0 ? void 0 : _e.trim());
